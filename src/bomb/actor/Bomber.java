...
public class Bomber extends Actor {
    ...
    protected int status;   //Trạng thái
    protected int score;    //Điểmm
    protected int heart;    //Lượt chơi



    public Bomber(int x, int y, int type, int orient, int speed, int sizebomb, int quantityBomb) {
        this.x = x;     //Tọa độ của Bomber
        this.y = y;     //Tọa độ của Bomber
        this.type = type;
    ...
    //Check Người chơi có chạm phải Enemy không
